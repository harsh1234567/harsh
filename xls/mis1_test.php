...
GROUP BY cname";
	...
	{ 
		...
		{   
		 ...
		 $sales_c=$rowss['CSale'];//."</br>";//mulfactor +plusfactor 
	    ...
	    $insert=mysqli_query($conn,$insert_in_sales);	
     	...
     	$insert_in_sales="update cafeinfo Location, SALE_TDATE,SALE_E,TBILL_T,AVG_SALE_T, TPROD_T, AVGPRODPBILL_T) value('$cname','$sales_c','$sales_e','$tbill','$avg_sale_t','$tprod_t','$avgprodpbill_t')";
	    $insert=mysqli_query($conn,$insert_in_sales);	
	}
