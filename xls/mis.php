...
padding: 4px;}
  ...
  "July", "August", "September", "October", "November", "December"
	...
	//alert(temp);
        ...
        if(newDate==0)
		{ if(pre_month=='september' ||pre_month=='June' ||pre_month=='April'&& pre_month!='February' )
		 {
			 newDate=30;
...
<input type='text' class='form-control'  id='curr_m'  value="" name="curr" readonly="readonly"/>			 
		  ...
		  <div  style='padding-left:190px;'>
		   <input name="submit" type="submit" class='btn btn-success' value='mis1 excel sheet'/>

		   <input name="submit1" type="submit" class='btn btn-success' value='mis2 excel sheet'/>

		   <input name="email_s" type="submit" class='btn btn-primary' value='mis send mail'/>
